                    ...
                    if (!hasDataTestId) {
                        context.report({
                            ...
                            fix(fixer) {
                                ...
                                return fixer.insertTextAfterRange([tagNameEnd, tagNameEnd], ` data-testid="${testId}"`);
                            },
                        });
                    }
                }
                ...
                while ((match = buttonRegex.exec(templateContent)) !== null) {
                    ...
                    context.report({
                        ...
                        fix(fixer) {
                            ...
                            return fixer.insertTextAfterRange([absolutePosition - 1, absolutePosition - 1], ` data-testid="${testId}"`);
                        },
                    });
                }
            }
